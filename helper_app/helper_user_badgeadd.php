...
$user_badge_add = NULL; // Initialize page object first

class cuser_badge_add extends cuser_badge {
	...
	// Page object name
	var $PageObjName = 'user_badge_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "helper_user_badgeview.php")
...
// Create page object
if (!isset($user_badge_add)) $user_badge_add = new cuser_badge_add();

// Page init
$user_badge_add->Page_Init();

// Page main
$user_badge_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$user_badge_add->Page_Render();
?>
<?php include_once "helper_header.php" ?>
<script type="text/javascript">

// Page object
var user_badge_add = new ew_Page("user_badge_add");
user_badge_add.PageID = "add"; // Page ID
var EW_PAGE_ID = user_badge_add.PageID; // For backward compatibility

// Form object
var fuser_badgeadd = new ew_Form("fuser_badgeadd");

// Validate form
fuser_badgeadd.Validate = function() {
...
fuser_badgeadd.Form_CustomValidate = 
...
fuser_badgeadd.ValidateRequired = true;
<?php } else { ?>
fuser_badgeadd.ValidateRequired = false; 
<?php } ?>
...
<?php $user_badge_add->ShowPageHeader(); ?>
<?php
$user_badge_add->ShowMessage();
?>
<form name="fuser_badgeadd" id="fuser_badgeadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($user_badge_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $user_badge_add->Token ?>">
<?php } ?>
...
<input type="text" data-field="x_user_id" name="x_user_id" id="x_user_id" size="30" placeholder="<?php echo ew_HtmlEncode($user_badge->user_id->PlaceHolder) ?>" value="<?php echo $user_badge->user_id->EditValue ?>"<?php echo $user_badge->user_id->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_badge_id" name="x_badge_id" id="x_badge_id" size="30" placeholder="<?php echo ew_HtmlEncode($user_badge->badge_id->PlaceHolder) ?>" value="<?php echo $user_badge->badge_id->EditValue ?>"<?php echo $user_badge->badge_id->EditAttributes() ?>>
</span>
