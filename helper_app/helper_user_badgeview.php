...
$user_badge_view = NULL; // Initialize page object first

class cuser_badge_view extends cuser_badge {
	...
	// Page object name
	var $PageObjName = 'user_badge_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["user_id"] <> "") {
				...
				$sReturnUrl = "helper_user_badgelist.php"; // Return to list
			}
			if (@$_GET["badge_id"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "helper_user_badgelist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "helper_user_badgelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($user_badge_view)) $user_badge_view = new cuser_badge_view();

// Page init
$user_badge_view->Page_Init();

// Page main
$user_badge_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$user_badge_view->Page_Render();
?>
<?php include_once "helper_header.php" ?>
<script type="text/javascript">

// Page object
var user_badge_view = new ew_Page("user_badge_view");
user_badge_view.PageID = "view"; // Page ID
var EW_PAGE_ID = user_badge_view.PageID; // For backward compatibility

// Form object
var fuser_badgeview = new ew_Form("fuser_badgeview");

// Form_CustomValidate event
fuser_badgeview.Form_CustomValidate = 
...
fuser_badgeview.ValidateRequired = true;
<?php } else { ?>
fuser_badgeview.ValidateRequired = false; 
<?php } ?>
...
<?php $user_badge_view->ExportOptions->Render("body") ?>
<?php
	foreach ($user_badge_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $user_badge_view->ShowPageHeader(); ?>
<?php
$user_badge_view->ShowMessage();
?>
<form name="fuser_badgeview" id="fuser_badgeview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($user_badge_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $user_badge_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="user_badge">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($user_badge->user_id->Visible) { // user_id ?>
	<tr id="r_user_id">
		<td><span id="elh_user_badge_user_id"><?php echo $user_badge->user_id->FldCaption() ?></span></td>
		<td<?php echo $user_badge->user_id->CellAttributes() ?>>
<span id="el_user_badge_user_id" class="form-group">
<span<?php echo $user_badge->user_id->ViewAttributes() ?>>
<?php echo $user_badge->user_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_badge->badge_id->Visible) { // badge_id ?>
	<tr id="r_badge_id">
		<td><span id="elh_user_badge_badge_id"><?php echo $user_badge->badge_id->FldCaption() ?></span></td>
		<td<?php echo $user_badge->badge_id->CellAttributes() ?>>
<span id="el_user_badge_badge_id" class="form-group">
<span<?php echo $user_badge->badge_id->ViewAttributes() ?>>
<?php echo $user_badge->badge_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user_badge->insert_at->Visible) { // insert_at ?>
	<tr id="r_insert_at">
		<td><span id="elh_user_badge_insert_at"><?php echo $user_badge->insert_at->FldCaption() ?></span></td>
		<td<?php echo $user_badge->insert_at->CellAttributes() ?>>
<span id="el_user_badge_insert_at" class="form-group">
<span<?php echo $user_badge->insert_at->ViewAttributes() ?>>
<?php echo $user_badge->insert_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fuser_badgeview.Init();
</script>
<?php
$user_badge_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$user_badge_view->Page_Terminate();
?>
