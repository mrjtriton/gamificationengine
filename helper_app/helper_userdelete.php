...
class cuser_delete extends cuser {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("helper_userlist.php"); // Prevent SQL injection, return to list
...
if ($user_deleteTotalRecs <= 0) { // No record found, exit
	...
	$user_delete->Page_Terminate("helper_userlist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php if ($user->user_id_external->Visible) { // user_id_external ?>
		<th><span id="elh_user_user_id_external" class="user_user_id_external"><?php echo $user->user_id_external->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $user_delete->RowCnt ?>_user_user_id_external" class="form-group user_user_id_external">
