...
define("EW_PROJECT_NAME", "helper_app", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{1E4BA4B9-446C-4642-AFD1-C346E6CE346F}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'PqifBS143oEJ9GSk', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/helper_app.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'gamification_lib', TRUE);
...
define("EW_UPLOAD_URL", "helper_ewupload11.php", TRUE); // Upload URL
