...
class cuser_list extends cuser {
	...
	function __construct() {
		...
		$this->AddUrl = "helper_useradd.php";
		$this->InlineAddUrl = $this->PageUrl() . "a=add";
		$this->GridAddUrl = $this->PageUrl() . "a=gridadd";
		$this->GridEditUrl = $this->PageUrl() . "a=gridedit";
		$this->MultiDeleteUrl = "helper_userdelete.php";
		$this->MultiUpdateUrl = "helper_userupdate.php";
	...
	function BasicSearchSQL($arKeywords, $type) {
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->user_id_external, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->user_id_external); // user_id_external
...
<?php if ($user->user_id_external->Visible) { // user_id_external ?>
	<?php if ($user->SortUrl($user->user_id_external) == "") { ?>
		<th data-name="user_id_external"><div id="elh_user_user_id_external" class="user_user_id_external"><div class="ewTableHeaderCaption"><?php echo $user->user_id_external->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user_id_external"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->user_id_external) ?>',1);"><div id="elh_user_user_id_external" class="user_user_id_external">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->user_id_external->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->user_id_external->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->user_id_external->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<a id="<?php echo $user_list->PageObjName . "_row_" . $user_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($user->user_id_external->Visible) { // user_id_external ?>
		<td data-name="user_id_external"<?php echo $user->user_id_external->CellAttributes() ?>>
<span<?php echo $user->user_id_external->ViewAttributes() ?>>
<?php echo $user->user_id_external->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
