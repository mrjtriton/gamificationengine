	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["user_id"] <> "") {
				...
				$sReturnUrl = "helper_userlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "helper_userlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "helper_userlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
<?php if ($user->user_id_external->Visible) { // user_id_external ?>
	<tr id="r_user_id_external">
		<td><span id="elh_user_user_id_external"><?php echo $user->user_id_external->FldCaption() ?></span></td>
		<td<?php echo $user->user_id_external->CellAttributes() ?>>
<span id="el_user_user_id_external" class="form-group">
<span<?php echo $user->user_id_external->ViewAttributes() ?>>
<?php echo $user->user_id_external->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
